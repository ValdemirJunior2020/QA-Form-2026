...
function calculateLiveScoreStats(criteria = [], answers = {}, fallbackResult = null) {
  ...
  if (!criteria.length && fallbackResult) {
    ...
    const details = Array.isArray(fallbackResult.details) ? fallbackResult.details : [];
  ...
  return (
    <section className="panel">
      ...
      {rows.map((row, index) => {
        ...
        const officialFinal = row["Is Official Final Score"] || row["Official Final Score"] || row.officialFinal || "NO";
